...
description: "A practical companion to Chapter 34 of CLRS, from polynomial verification and Cook–Levin to Steiner trees in VLSI."
---
...
flowchart LR
  ...
  SAT["SAT"] -->|"Cook–Levin: every L in NP reduces to SAT"| NPC
```
